...
@RestController
@RequestMapping("/api/signup-kindergartens")
@EnableSwagger2
@Slf4j
//@CrossOrigin(origins = "https://mommyogi.com")
@CrossOrigin("*")
//회원가입시 필요한 유치원 api
public class SignUpKinderGartenController {
    ...
    public SignUpKinderGartenController(KinderGartenService kinderGartenService, ResponseService responseService, StudentService studentService, ModelMapper modelMapper) {
